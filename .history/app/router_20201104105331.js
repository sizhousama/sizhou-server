 ...
 * @LastEditors: sizhou
 * @LastEditTime: 2020-11-04 10:53:30
 */
'use strict';
...
module.exports = app => {
  ...
  // 评论
  router.get('/user/delArticle', controller.article.comments);
  router.post('/user/delArticle', controller.article.createComment);
  router.post('/user/delComment', controller.article.deleteComment);
  // home
